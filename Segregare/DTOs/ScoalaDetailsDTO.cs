...
namespace Segregare.DTOs
{
    public class ScoalaDetailsDTO
    {
        ...
        public double UProcent { get; set; }
        public double CProcent { get; set; }
        public double UProcentC { get; set; }
        public double CProcentC { get; set; }
        public List<string> UnitateNume { get; set; }
        public List<int> UnitateId { get; set; }
        public List<string> UnitateModerator { get; set; }
    }
}
